...
import { LayoutDashboard, MessageSquareCode, FlameKindling, BarChart3, LogOut, ShieldAlert } from "lucide-react";
...
export default function Sidebar({ activeTab, setActiveTab, user, onLogout }: SidebarProps) {
  ...
  return (
    <aside className="w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col text-slate-600 dark:text-slate-300 h-screen fixed top-0 left-0 z-20 font-sans">
      {/* Brand logo */}
